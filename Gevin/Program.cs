...
//Func<int, int, int> calc2 =  ( a, b) => a + b;

//int result = calc(1, 2);
//int result2 = calc2(1, 2);
...
//Console.WriteLine($"Total annual Salry: {calculateTotalAnnualSalary(60000,2)}");
...
//List<Employee> employeesFiltered = FilterEmployees(employees,e => e.AnnualSalary > 45000);
